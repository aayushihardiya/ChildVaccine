...
@WebServlet("/ViewQueryController")
public class ViewQueryController extends HttpServlet {
		...
		protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
			...
			try
			{
				...
				ChildDetailsService childDetailsService = new ChildDetailsServiceImpl();
					List<ParentQuery> parentQuery = childDetailsService.viewAllQueries();
					...
					out.println("<img src='img/questions.png'><br><br><br>");
					
					out.println( "<div class='main'>");
					
					
					
					for(ParentQuery reg :parentQuery )
					{
						out.println("<div class='feedback'>");
						out.println("<h6>Child Id: ");
						out.println(reg.getChildId());
						out.println("</h6>");
						out.println("<hr>");
						out.println("<h6>Query Title: </h6><p>");
						out.println(reg.getParentQueryTitle());
						out.println("</h6>");
						out.println("<hr>");
						out.println("<h6>Query Description: </h6><p>");
						out.println(reg.getParentQueryDetail());
						out.println("</p></div><br><br>");
						
					}
					out.println("</div> <br><br></center>");
					...
					if(parentQuery != null)
					{
						request.setAttribute("list", parentQuery);

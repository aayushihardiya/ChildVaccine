...
public interface ChildDetailsService {
	...
	ChildDetailsDTO getChildInfo(String childId, String password);
	...
	boolean registerHospital(HospitalDTO hospitalDetailsDTO);
	 ...
	 HospitalDTO getHospitalInfo(String hospitalEmail, String password);

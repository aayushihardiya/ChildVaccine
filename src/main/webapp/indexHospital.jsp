...
<body>
				...
				<div class="col-lg-6 pl-0">
					<div class="about_box">
						<div class="section-title-wrap text-left">
							<h1>Update Vaccination Schedule</h1>
							<p>
								Update the vaccination schedule of children.
							</p>
						</div>
							...
							<div class="row">
								...
								<div class="col-lg-6 col-md-6">
									<div class="activity_box">
										...
										<p>Name of the hospital where vaccination was given</p>
									</div>
								</div>
							</div>
						</div>
	...
	<!--================ Start Feedback Area =================-->
	<section class="feedback_area section_gap relative" style=" padding-bottom:60px;">
		<div class="container">
			<div class="row justify-content-center section-title-wrap">
				<div class="col-lg-12">
					<h1>Update Diet Chart</h1>
					<p>
						Update proper diet for the children as consult by the doctors.
						...
						<div class="col-lg-6">
							<div class="single-feedback-carusel">
								<div class="d-flex flex-row">
									<h4 class=""> Update Diet Chart</h4>
									
								</div>
								<p class="">
									Update the meals of children according to their groups. Mention the quantity and types of meals. 
								</p>
							</div>
						</div>
					</div>
	...
	<section class="service_area section_gap" style="padding-top: 60px;">
		<div class="container">
			<div class="row justify-content-center section-title-wrap">
				<div class="col-lg-12">
			...
			<div class="row">
				...
				<div class="col-lg-3 col-md-6">
					<div class="single_service">
						...
						<p>
							View the queries that are raised by the parents and reply to them as soon as possible.
						</p>
					</div>
				</div>
				<div class="col-lg-3 col-md-6">
					<div class="single_service">
						...
						<p>
							View the feedbacks of the parents so that hospital can improve their facilities.
						</p>
					</div>
				</div>
				<div class="col-lg-3 col-md-6">

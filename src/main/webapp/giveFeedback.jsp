...
<body>
 ...
 <center>
        <form action="GiveFeedbackParentController" method="post">
       
        <div class="feedback">
        
        <p> Submit Your Feedback Here</p>
        
         <img src="img/feedback.png" width="100px" height="100px"><br><br><br>
        <input type="text" name="childId" placeholder="Child Id"><br><br>
     
        <textarea rows="4" columns="50" name="feedback" placeholder=""> Your Description...</textarea><br><br>
